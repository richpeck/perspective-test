...
module Game # Game::Map
  ...
  class Map
    ...
    def contains? c1, c2 # c1 = co-ords1 (array of [x,y]), c2 = co-ords2 (array of [x,y])
      ...
      @walls.each { |wall| return true if intersects? line, wall }

      # Doors 
      # Cycle through the doors to check if the user is going to intersect
      @doors.each { |door| return true if intersects? line, door } 

      # If no responses, return false 
      return false
